...
public class TravelDaoImpl implements TravelDao{
	...
	public int Insert(Travel b) {
		...
		Object records[] = {b.getHotelid(),b.getHotelname(),b.getHotelDestination(),b.getHotelDate()}; 
	...
	public int Update(Travel b) {
		// TODO Auto-generated method stub
		String sql = "update hoteldetails set HotelDate = ? where Hotelid = ?";
		Object[] args = {b.getHotelDate(),b.getHotelid()};
