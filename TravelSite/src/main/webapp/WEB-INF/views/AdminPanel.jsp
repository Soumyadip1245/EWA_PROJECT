            ...
            <div class="profile flex1">
              ...
              <div class="box">
                ...
                <div id="id01" class="modal">
                    ...
                    <form:form class="modal-content animate" action="list" method="post" modelAttribute="travel" >
                    
                        <button type = "submit" style = "margin-left : 1150px" ><a href="form" style="color: white">New Flight  <i class="fas fa-user"></i></a></button>
                      <table>
                          <thead>
                            <tr>
                              <th> Hotel Id</th>
                          ...
                          <c:forEach var="travel" items="${travel}">
                            <tr>
                              ...
                              <td> 
                              <button type = "button" style = "height: 28px ;margin-top:-50px; "><a href = "deleteRecord?HotelId=${travel.hotelid}" style ="color:white">Delete  <i class="fas fa-trash"></i></a></button> 
                              <button type="button" style = "height: 28px"><a href = "updateForm?HotelId=${travel.hotelid}" style="color:white">Edit  <i class="fas fa-edit"></i></a></button>
                              </td>
                            </tr>
                            </c:forEach>
                          </tbody>
