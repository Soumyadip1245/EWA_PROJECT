...
.secondary {
  ...
  transition: all .3s ease-out;
  cursor: pointer;
  /* position:absolute; top:608; left:1160 */
  position: relative;
    top: -54%;
    left: 102%;
}
...
<div class="container">
  <section class="menu">
    ...
    <a href ="registration"><button class ="secondary1"><i class="fas fa-user" style = "padding-right: 10px;"></i>Account </button></a>
  </section>
  
  <section class="slide">
    <div class="desc">
      <small>Get ready for Chilling</small>
      <h1><span>Discover</span> The<br>Most Engaging<br>Places.</h1>
  ...
  <form action="Search" method ="post">
    <div class="items">
      <div class="item destination">
        ...
        <input type="text" name="desti" placeholder="Where You Want To Go?" />
        </label>
     </div>
      <div class="item checkin">
        <span>Check In</span>
        <input type="date" name ="date" placeholder="Where You Want To Go?" />
      </div>
      <div class="item checkin">
        <span>Check Out</span>
        <input type="date" placeholder="Where You Want To Go?" />
      </div>
      <div class="item guests">
        <span>Guests & Rooms</span>
        <input type="text" placeholder="No. of guest to go with?" />
      </div>
    </div>
    
    <button type="submit"  class="secondary"><i class='fas fa-search' style ="padding-left : 8px" ></i>&nbsp;Search </button>
