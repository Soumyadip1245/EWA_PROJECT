    ...
    <section class="head">
      <div class="container flex1">
        <div class="left flex1">
          <div class="logo">
            <img src="https://i.imgur.com/mawL0jK.png" alt="">
          </div>
        ...
        <div class="right flex ">
          ...
          <div class="admin flex">
            <img src="https://www.kindpng.com/picc/m/10-109847_admin-icon-hd-png-download.png" alt="">
            <div class="text flex">
              <label>Admin</label>
    ...
    <div class="container">
      ...
      <div class="content flex">
        <div class="content_left">
                      ...
                      <table>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td> <button style = "height: 28px; ;margin-top:0%;margin-right:auto">Delete</button> <button type="submit" style = "height: 28px">Edit</button></td>
                            </tr>
          ...
          <section>
        <!-- insertion -->
        <form:form action="processForm" style="margin-left: 250px;margin-top: 50px;border-right-width: 200px;width: 500px;" method="post" modelAttribute="travel">
            <h2 class="title">Insert Hotel</h2>
            <div class="input-field1">
              <i class="fas fa-user"></i>
              <form:input type="text" placeholder="Hotel Id" path= "Hotelid"/>
            </div>
            <div class="input-field1">
              <i class="fas fa-envelope"></i>
              <form:input type="text" placeholder="Hotel Name" path="Hotelname"/>
            </div>
            <div class="input-field1">
                <i class="fas fa-female"></i>
                <form:input type="text" placeholder="Destination" path="HotelDestination"/>
              </div>
            <div class="input-field1">
              <i class="fas fa-lock"></i>
              <form:input type="text" placeholder="Date" path="HotelDate"/>
            </div>
            
             <div class="input-field1">
                <i class="fas fa-money-check"></i>
                <form:input type="text" path="HotelPrice" placeholder="Price"  />
              </div>
              <div class="input-field1">
                <i class="fas fa-phone"></i>
                <form:input type="text" path="HotelContact" placeholder="Contact"/>
              </div>
            <input type="submit" class="btn1" value="Insert" />
