    ...
    <div class="container">
      ...
      <div class="content flex">
        <div class="content_left">
          ...
          <section>
        <!-- insertion -->
        <form:form action="processUpdate" style="margin-left: 250px;border-right-width: 200px;width: 500px;" method = "post" modelAttribute="travel">
            <h2 class="title">Update Hotel</h2>
            <div class="input-field1">
              <i class="fas fa-user"></i>
              <form:input type="text" path="Hotelid" readonly="true"/>
            </div>
            <div class="input-field1">
              <i class="fas fa-envelope"></i>
              <form:input type="text" path="Hotelname"  readonly="true"/>
            </div>
            <div class="input-field1">
                <i class='fas fa-map-marker-alt'></i>
                <form:input type="text" path="HotelDestination"  readonly="true"/>
              </div>
              <div class="input-field1">
              <i class="fas fa-calendar"></i>
              <form:input type="text" path="HotelDate"  />
            </div>
              <div class="input-field1">
                <i class="fas fa-money-check"></i>
                <form:input type="text" path="HotelPrice"  />
              </div>
              <div class="input-field1">
                <i class="fas fa-phone"></i>
                <form:input type="text" path="HotelContact"  readonly="true"/>
              </div>
